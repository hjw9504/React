...
export default function ResetPassword() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center px-6 py-16 transition-colors duration-200">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
        ...
        <div className="mb-5">
          ...
          <input
            ...
            className="w-full mt-2 px-3 py-2 border border-rose-200 dark:border-gray-600 rounded-lg
                       bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200
                       focus:outline-none focus:ring-2 focus:ring-rose-300
        ...
        <div className="flex gap-4 justify-center">
          ...
          <button
            onClick={goSignIn}
            className="flex-1 border border-gray-200 dark:border-gray-600
                       text-gray-600 dark:text-gray-300 font-semibold py-2 rounded-xl
