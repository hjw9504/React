      ...
      <main className="grid grid-cols-1 md:grid-cols-12 gap-6 px-4 sm:px-6 py-4 sm:py-6">
        ...
        <aside className="col-span-1 md:col-span-4 order-1 md:order-2">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-4">
            <h2 className="text-lg font-semibold mb-3 text-gray-800 dark:text-gray-100">추천 사용자</h2>
            <ul className="space-y-3">
              <li className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-gray-700 dark:text-gray-300">cool_dev</span>
                </div>
                <button className="text-sm text-indigo-600 dark:text-indigo-400">팔로우</button>
              </li>
              <li className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <img
                    ...
                    className="w-8 h-8 rounded-full"
                  />
                  <span className="text-gray-700 dark:text-gray-300">fun_coder</span>
                </div>
                <button className="text-sm text-indigo-600 dark:text-indigo-400">팔로우</button>
              </li>
            </ul>
